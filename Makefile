...
install: go.sum
	go install -mod=readonly $(BUILD_FLAGS) ./orai/cmd/oraid

build:
	go build $(BUILD_FLAGS) -o build/oraid ./orai/cmd/oraid
...
proto-js: 
	./orai/scripts/protocgen-js.sh $(SRC_DIR)
.PHONY: proto-js

proto-swagger: 
	./orai/scripts/protocgen-swagger.sh $(SRC_DIR)
.PHONY: proto-swagger
